...
Keypad_ConfigType Keypad ={
		.keypad_cols_pins[0]= DIO_PINC2_CHANNEL18,
		.keypad_cols_pins[1]= DIO_PINC3_CHANNEL19,
		.keypad_cols_pins[2]= DIO_PINC4_CHANNEL20,
		.keypad_cols_pins[3]= DIO_PINC5_CHANNEL21,
		.keypad_control_pins = KEYPAD_ROW_CONTROL,

		.keypad_rows_pins[0]=DIO_PINC6_CHANNEL22,
		.keypad_rows_pins[1]=DIO_PINC7_CHANNEL23,
		.keypad_rows_pins[2]=DIO_PIND2_CHANNEL26,
		.keypad_rows_pins[3]=DIO_PIND3_CHANNEL27,
